...
metadata {
	definition (name: "Netatmo Basestation", namespace: "cealtea", author: "Brian Steere,cscheiene") {
	...
	tiles (scale: 2) {
		multiAttributeTile(name:"main", type:"generic", width:6, height:4) {
            tileAttribute("carbonDioxide", key: "PRIMARY_CONTROL") {
                attributeState "carbonDioxide", label:'${currentValue}ppm', icon:"st.Electronics.electronics1", unit: "CO2", backgroundColors:[
        ...
        main(["main"])
 		details(["main","min_temp","date_min_temp","temperature", "max_temp","date_max_temp", "temp_trend","sound", "pressure", "units", "soundPressureLevel", "pressure_trend", "refresh", "lastupdate"])
	}
}
